...
if(!file.exists(paste0('Sim',setting_number,'_Exact/Results',data_number,'-',chain_number,'.xlsx')) & 
   !file.exists(paste0('Sim',setting_number,'_Exact/Results',data_number,'.rds'))){
  ...
  result <- postsamp_Alg5.4Exact_NUTS_MCMC_onechain(eps0 = eps0, M_init = M_init,
  ...
  write_xlsx(result,path=paste0('Sim',setting_number,'_Exact/Results',data_number,'-',chain_number,'.xlsx'))
}
