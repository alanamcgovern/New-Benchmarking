...
setwd(paste0("/Users/alanamcgovern/Desktop/Research/New_Benchmarking/Simulation_Study/Results/Sim",setting_num))
...
for(i in 1:nsim){
  ...
  admin2.res.tmp <- data.frame(A2 = 1:n_admin2, iter.id = i,
                               ...
                               bench.lower50 = apply(admin2.samples,2,quantile,prob = 0.25),
                               bench.upper50 = apply(admin2.samples,2,quantile,prob = 0.75),
  ...
  admin1.res.tmp <- data.frame(admin1 = 1:n_admin1, iter.id = i,
                               ...
                               bench.lower50 = apply(admin1.samples,2,quantile,prob = 0.25),
                               bench.upper50 = apply(admin1.samples,2,quantile,prob = 0.75),
...
load(paste0("/Users/alanamcgovern/Desktop/Research/New_Benchmarking/Simulation_Study/Results/sim",setting_num,"_Dir.rda"))
...
save(admin1.res, file = paste0("/Users/alanamcgovern/Desktop/Research/New_Benchmarking/Simulation_Study/Results/sim",setting_num,"results_admin1.rda"))
save(admin2.res, file = paste0("/Users/alanamcgovern/Desktop/Research/New_Benchmarking/Simulation_Study/Results/sim",setting_num,"results_admin2.rda"))


## Add Stan estimates =============
setwd(paste0("/Users/alanamcgovern/Desktop/Research/New_Benchmarking"))
  
  admin1.res.stan <- readRDS(file=paste0('Simulation_Study/Results/Stan_Admin1Summary_',setting_num,'.rds'))
  admin2.res.stan <- readRDS(file=paste0('Simulation_Study/Results/Stan_Admin2Summary_',setting_num,'.rds'))
  
  load(paste0("/Users/alanamcgovern/Desktop/Research/New_Benchmarking/Simulation_Study/Results/sim",setting_num,"results_admin1.rda"))
  load(paste0("/Users/alanamcgovern/Desktop/Research/New_Benchmarking/Simulation_Study/Results/sim",setting_num,"results_admin2.rda"))
  ...
  save(admin1.res, file = paste0("/Users/alanamcgovern/Desktop/Research/New_Benchmarking/Simulation_Study/Results/sim",setting_num,"results+stan_admin1.rda"))
  save(admin2.res, file = paste0("/Users/alanamcgovern/Desktop/Research/New_Benchmarking/Simulation_Study/Results/sim",setting_num,"results+stan_admin2.rda"))


## Process Exact benchmarking estimates ===========
setwd(paste0("/Users/alanamcgovern/Desktop/Research/New_Benchmarking/Simulation_Study/Results/Sim",setting_num,"_Exact"))
...
for(i in 1:nsim){
  ...
  admin2.res.tmp <- data.frame(A2 = 1:n_admin2, iter.id = i,
                               ...
                               exact.lower50 = apply(admin2.samples,2,quantile,prob = 0.25),
                               exact.upper50 = apply(admin2.samples,2,quantile,prob = 0.75),
...
load(paste0("/Users/alanamcgovern/Desktop/Research/New_Benchmarking/Simulation_Study/Results/sim",setting_num,"results+stan_admin1.rda"))
load(paste0("/Users/alanamcgovern/Desktop/Research/New_Benchmarking/Simulation_Study/Results/sim",setting_num,"results+stan_admin2.rda"))

admin1.res <- merge(admin1.res, admin1.res.exact)
admin2.res <- merge(admin2.res, admin2.res.exact) 
admin2.res <- merge(admin.key,admin2.res)

save(admin1.res, file = paste0("/Users/alanamcgovern/Desktop/Research/New_Benchmarking/Simulation_Study/Results/sim",setting_num,"results_all_admin1.rda"))
save(admin2.res, file = paste0("/Users/alanamcgovern/Desktop/Research/New_Benchmarking/Simulation_Study/Results/sim",setting_num,"results_all_admin2.rda"))
